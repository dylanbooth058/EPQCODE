...
st.set_page_config(page_title=r"Digit Recognition")
st.title("EPQ Digit Recognition")
...
footer:before{
    content: 'Programmed by Dylan Booth';
    display:block;
    position:relative;
    color:tomato;
}
...
st.success("""Draw in the white space below!""")
st.header("Drawing Space")
